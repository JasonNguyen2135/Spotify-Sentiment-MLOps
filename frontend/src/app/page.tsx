...
export default function Home() {
  ...
  return (
    <div className="animate-in fade-in duration-700">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              { name: 'Total Preds', value: stats.total_predictions.toLocaleString(), icon: Activity, color: 'text-blue-500', bg: 'bg-blue-50' },
              ...
              <div key={item.name} className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm transition-all hover:shadow-md">
                ...
                <h3 className="text-slate-400 text-xs font-bold uppercase">{item.name}</h3>
                <p className="text-xl font-black text-slate-900 mt-1">{item.value}</p>
              </div>
            ))}
          </div>

          <div className="mt-8 overflow-hidden bg-slate-900 rounded-3xl relative">
            ...
            <div className="p-8 md:p-12 relative z-10">
              ...
              <p className="text-slate-300 mb-6 max-w-xl text-sm">
                Quản trị viên có quyền ép model học lại dữ liệu mới nhất từ MongoDB.
              </p>
      ...
      {/* --- PHẦN DÀNH CHO TẤT CẢ USER (NHẬP CÂU LẺ) --- */}
