...
import { 
  ...
  FileText, ArrowLeftRight, ChevronRight, BellRing, Ticket as TicketIcon, Settings, RefreshCw
} from 'lucide-react';
          ...
          <div className="animate-in fade-in slide-in-from-bottom duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              ...
              <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                ...
                <div className="mb-6">
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Support Email Destination</label>
                  <input 
                    type="email" 
                    placeholder="support@company.com"
                    className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-2.5 text-xs font-bold text-slate-700 outline-none focus:ring-2 focus:ring-brand/20 transition-all"
                  />
                </div>
                ...
                <div className="space-y-4 overflow-auto max-h-[300px] pr-2">
                  <div className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <button onClick={() => alert("Ticket forwarded successfully!")} className="bg-slate-900 text-white px-3 py-1.5 rounded-lg text-[9px] font-black uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center gap-2">
